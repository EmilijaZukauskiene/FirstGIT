package lt.sdacademy.designpatterns.creational.builder.example;
...
public class Pizza {
    ...
    public boolean isAddCheese() {return isAddCheese;}
    public boolean isAddSauce() {return isAddSauce;}
    public boolean isTakeAway() {return isTakeAway;}
    @Override
    public String toString() {
        return "Pizza= " + this.getName() + ", Size= " + getSize()
                + (this.isAddCheese ? ", add cheese" : "")
                + (this.isAddSauce ? ", add cheese" : "")
                + (this.isTakeAway ? ", add cheese" : "");
    }
